                        ...
                        <div class="container bg-white rounded mt-2 mb-2 px-0">
                                ...
                                <form class="form-horizontal" action="newpassword" method="POST" id="frm-changePass">
                                    ...
                                    <div class="form-group row justify-content-center px-3">
                                        <div class="col-9 px-0">
                                            <input type="text" name="username" id="username" value="${requestScope.username}" hidden/>
                            ...
                            <div class="mx-0 px-0 bg-light">
                                ...
                                <div class="pt-2">
                                    <div class="row justify-content-center">
                                        <h5>
                                            Bạn không có tài khoản? <span><a href="register" class="text-danger"> Đăng ký ngay!</a></span>
                                        </h5>
                                    </div>
                                    <div
