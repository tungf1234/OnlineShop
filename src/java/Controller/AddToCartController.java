...
public class AddToCartController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("user") == null && session.getAttribute("usergg") == null) {
            // Phiên rỗng, chuyển hướng đến trang login
            ...
            response.sendRedirect("productdetails?mod=" + id + "&mod1=" + cateid);//thay cai duoi
        }
    }
